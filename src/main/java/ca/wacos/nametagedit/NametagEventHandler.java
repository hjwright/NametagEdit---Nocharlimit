...
class NametagEventHandler implements Listener {
     ...
     * read player information in this event.<br><br>
     *
     * This event updates nametag information, and the tab list (if enabled).
     *
     * @param e the {@link org.bukkit.event.player.PlayerJoinEvent} associated
     * with this listener.
     */
     ...
     * player's nametag.
     *
     * @param e the {@link org.bukkit.event.entity.PlayerDeathEvent} associated
     * with this listener.
     */
    @EventHandler
