 ...
 * A group node prefix and suffix being set
 * (NametagChangeReason.GROUP_NODE)</br>
 * A prefix / suffix is set through the plugin (NametagChangeReason.SET_PREFIX /
 * NametagChangeReason.SET_SUFFIX)</br>
...
public class NametagChangeEvent extends Event implements Cancellable {
     ...
     * is not cancelled
     * </br></br>
     * NametagChangeType.HARD - The current prefix and suffix is completely
     ...
     * or resetting the nametag back to the default.
     * </br></br>
     *
