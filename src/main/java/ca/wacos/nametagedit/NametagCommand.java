...
class NametagCommand implements CommandExecutor {
     ...
     *
     * @param sender the {@link org.bukkit.command.CommandSender} to execute
     * from
     * @return true
     * @see
     * ca.wacos.nametagedit.Updater#manuallyCheckForUpdates(org.bukkit.command.CommandSender)
     */
